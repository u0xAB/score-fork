...
public class SDMenuBar extends JMenuBar implements ActionListener
{
    ...
    public SDMenuBar(ResourceBundle b, Preferences p) 
    {
        ...
        loadMenu = new JMenuItem(new ImageIcon(getClass().getResource("/resources/exercises.png")));
        loadMenu.setText("Load Exercise...");
    ...
    public void actionPerformed(ActionEvent ae)
    {
		...
		if (ae.getSource() == rblanguageen)
			...
			this.firePropertyChange("midiOptions", false, true);
                   ...
                   if (returnVal == JFileChooser.APPROVE_OPTION) {
                        ...
                        ScriptVector.INSTANCE.load(path);
                   }
                }
		...
		{
			String text = "<html><b>ScoreDate v. 3.2-f<br>written by Massimo Callegari,<br>";
                        text += "forked by Andrei Borovsky (see README for more detail)<br>";
